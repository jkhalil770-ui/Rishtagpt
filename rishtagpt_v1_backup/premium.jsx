    ...
    <>
      ...
      <div className="sheet">
        ...
        <div className="grid grid-cols-1 gap-2.5">
          <button className="gold-btn rounded-2xl py-3.5 flex items-center justify-center gap-2 text-[15px]">
            <span style={{
          ...
          <button className="rounded-2xl py-3.5 flex items-center justify-center gap-2 text-[15px] font-semibold"
          ...
          <button className="rounded-2xl py-3.5 flex items-center justify-center gap-2 text-[15px] font-medium"
