...
/* ─── Persistent header ─── */
function Header({ onPremium, onHome }) {
  return (
    <div className="topbar">
      ...
      >
        <Ic.crescent style={{ width: 22, height: 22, color: "var(--gold-2)" }} />
        <span className="font-display gold-text text-[20px] tracking-tight font-semibold">
          RishtaGPT
        </span>
      </button>
      <div className="flex items-center gap-2">
        <button className="iconbtn" aria-label="Language">
          <Ic.globe style={{ width: 18, height: 18 }} />
        </button>
